...
// String 끼리 == 하면  주소비교 String 주소값을 가진다. 그래서 equals로 비교

public class L_String {

    // 1. charAt(int index)
    // 설명 : 문자열에서 특정 위치에 있는 문자(char)을 반환합니다.
    ...
    // 설명 : 두 문자열의 값을 비교하여 같은면 true ,다르면 false를 반환한다.
    // 활용 : 문자열 비교에서 자주 사용한다.
    ...
    public static void exam11(){
        String str = "apple";
        String str2 = "banana";
        int result = str.compareTo(str2);//str1을 str2에 비교
        System.out.println(result);
    }
