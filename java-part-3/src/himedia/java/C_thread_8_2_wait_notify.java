...
// 그래도lock을 얻을 수 있는 것은 하나의 스레드일 뿐이고
...
// 모든 객체의 waiting pool에 있는 스레드가 꺠어지는 것이 아니다.
// notifyAll()이 호출된 객체의 waiting pool에 대기 중인 스레드만 해당된다.
