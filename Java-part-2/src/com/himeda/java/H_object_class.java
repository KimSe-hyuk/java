...
// 컴파일러는 자동적으로 상속이 없는 클래스에 extends Object를 추가함으로써 모든 클래스의 조상이 될 수 있도록 한다.
// 만약 다른 클래스로부터 상속을 받는다고 하더라도 상속계층도를 따라 조상클래스, 조상클래스의 조상클래스를 찾아
// 올라가다 보면 결국 최상위 조상은 Object클래스이다.
