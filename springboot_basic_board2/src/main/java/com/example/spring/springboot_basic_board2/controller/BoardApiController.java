...
import com.example.spring.springboot_basic_board2.dto.BoardDeleteRequestDTO;
import com.example.spring.springboot_basic_board2.dto.BoardDetailResponseDTO;
import com.example.spring.springboot_basic_board2.dto.BoardListResponseDTO;
import com.example.spring.springboot_basic_board2.model.Board;
import com.example.spring.springboot_basic_board2.service.BoardService;
...
public class BoardApiController {
    ...
    public ResponseEntity<Void> saveArticle(
        ...
        System.out.println("title : "+ title+"userId : "+ userId+"content : "+ content+"file : "+ file);
    ...
    @GetMapping("/write")
    public BoardDetailResponseDTO updateArticle(@PathVariable long id) {
        Board boardDetail = boardService.getBoardDetail(id);
        return BoardDetailResponseDTO.builder()
                .title(boardDetail.getTitle())
                .content(boardDetail.getContent())
    ...
    public ResponseEntity<Void> updateArticle(
        ...
        boardService.updateArticle(id,title,userId,content,file);
        return ResponseEntity.ok().build();
    }*/
