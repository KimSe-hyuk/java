...
public class B_generic_2<T extends Number> {
    ...
    private T subtract(T i, T i1) {
        if( i instanceof Integer ) {
            return (T) Integer.valueOf(i1.intValue()/i1.intValue()) ;
        }else if( i instanceof Double ) {
            return (T) Double.valueOf(i1.doubleValue()-i1.doubleValue()) ;
        }
        throw new UnsupportedOperationException("지원되지 않는 타입입니다.");
    }
    // 곱셈
