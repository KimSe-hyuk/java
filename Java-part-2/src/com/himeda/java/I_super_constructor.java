...
// 자식클래스의 멤버가 조상 클래스의 멤버를 사용할 수도 있으므로
...
// 그렇제 않으면 컴파일러가 super()를 생성자의 첫 줄에 삽입한다.

// super를 안써도 상속받은데에서 문제가 없어면 부모에 상속자가 기본생성자라 그렇다
// 자식에 경우에는 super()가 기본으로 되어있는것이다.
public class I_super_constructor {
    public static void main(String[] args) {
        I_porint3d porint3d = new I_porint3d();
